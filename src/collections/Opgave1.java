...
public class Opgave1 {
	...
	private static void main(String[] args) {
		...
		deelnemers.add("Piet");
		deelnemers.add("Rikske");
		deelnemers.add("Wiske");
		deelname.put(quizNaam, deelnemers);
		// quiz2
		quizNaam = "Aftrekken";
		deelnemers = new ArrayList<String>();
		deelnemers.add("Jonas");
		deelnemers.add("Rikske");
		deelnemers.add("Wiske");
		deelname.put(quizNaam, deelnemers);
		// quiz3
	...
	public static String toonDeelnemers(Map<String, List<String>> deelname) {
		...
		String quizNaam = IO.leesStringMetVenster(
				"Kies quiznaam uit volgende lijst\n" + quizNamen.toString(),
				"Deelnemers aan quiz");
	...
	public static String toonDeelnames(Map<String, List<String>> deelname) {
		...
		String deelnemer = IO.leesStringMetVenster("Typ naam deelnemer",
				"Deelnames aan quiz");
