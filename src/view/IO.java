...
public class IO {
	...
	static private BufferedReader lezer = new BufferedReader(
    ...
    */
	public static String leesString(String boodschap) {
		...
		try {
			...
			System.out
					.println("Er is een invoer/uitvoer fout opgetreden: + ioe.getClass().toString()");
    ...
    */
	public static float leesFloat(String boodschap) {
		...
		try {
			...
			System.out
					.println("Gelieve een geldige float waarde in te voeren.");
		}
		return f;
	}
    ...
    */
	public static double leesDouble(String boodschap) {
		...
		try {
			...
			System.out
					.println("Gelieve een geldige double waarde in te voeren.");
		}
		return d;
	}
    ...
    */
	...
	public static String leesStringCorrectieMetVenster(String str,
			String teCorrigeren) {
	...
	public static byte leesByteMetVenster() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null,
					"Gelieve een geldig byte waarde in te voeren.", "Fout",
    ...
    */
	public static short leesShortMetVenster() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null,
					"Gelieve een geldig short waarde in te voeren.", "Fout",
					JOptionPane.ERROR_MESSAGE);
		}
		return sh;
	}
    ...
    */
	public static int leesIntMetVenster() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null,
					"Gelieve een geldig int waarde in te voeren.", "Fout",
					JOptionPane.ERROR_MESSAGE);
		}
		return i;
	}
    ...
    */
	public static long leesLongMetVenster() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null,
					"Gelieve een geldig long waarde in te voeren.", "Fout",
					JOptionPane.ERROR_MESSAGE);
		}
		return l;
	}
    ...
    */
	public static float leesFloatMetVenster() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null,
					"Gelieve een geldige float waarde in te voeren.", "Fout",
					JOptionPane.ERROR_MESSAGE);
		}
		return f;
	}
