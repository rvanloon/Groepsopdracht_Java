...
public class ScoreAntwoordenMetPogingenEnTijd implements QuizScore {
	...
	// maximum aantal punten bij goed antwoord binnen tijd en eerste poging, 0
	// bij antwoord dat fout is of buiten tijd, de helft van de punten
			...
			if (oa.getQuizopdracht().getOpdracht()
					...
					&& (oa.getAntwoordTijd() <= oa.getQuizopdracht()
							.getOpdracht().getMaxAntwoordTijd() || // antwoord
																	...
																	// binnen
																	// tijd zijn
					oa.getQuizopdracht().getOpdracht().getMaxAntwoordTijd() == 0)) { // of
																						// er
																						// is
																						// geen
																						// max
